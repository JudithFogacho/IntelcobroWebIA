...
exports.DiscountPercentage = void 0;
/**
...
class DiscountPercentage {
     ...
     */
    isSpecialDiscount() {
        return DiscountPercentage.SPECIAL_DISCOUNTS.includes(this._value);
    }
    /**
     ...
     */
    static fromString(percentageString) {
     ...
     */
    static getRandomSpecialDiscount() {
 ...
 */
DiscountPercentage.MIN_DISCOUNT = 0;
DiscountPercentage.MAX_DISCOUNT = 100;
/**
 * Descuentos especiales predefinidos
 */
DiscountPercentage.SPECIAL_DISCOUNTS = [5, 10, 15, 20, 25, 30, 50];
